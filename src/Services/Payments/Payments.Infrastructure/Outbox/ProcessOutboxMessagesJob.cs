...
public class ProcessOutboxMessagesJob(PaymentDbContext dbContext, IOptions<OutboxOptions> options, ILogger<ProcessOutboxMessagesJob> logger, IPublisher publisher,
